...
function OrbitControls ( object, domElement ) {
    ...
    this.getDampingTheta = function () {

        return publicSphericalDelta.theta;
    ...
    this.setDisableEvents = function(disableEvents) {
        scope.enabled = !disableEvents;
    };
    ...
    this.getTouchOverride = function () {

        return scope.touchOverride;
    ...
    this.getFirstMouseMove = function () {

        return scope.firstMouseMove;
    ...
    this.update = function() {
        ...
        return function update () {
            ...
            if (!this.staticRotation) {
                sphericalDelta.theta = THREE.Math.clamp(sphericalDelta.theta, -this.normalizedLimit, this.normalizedLimit);
                sphericalDelta.phi = THREE.Math.clamp(sphericalDelta.phi, -this.normalizedLimit, this.normalizedLimit);
            }
            ...
            //console.log("panTarget: ", panOffset, " scope.panTarget: ", scope.panTarget)
            ...
            if ( scope.enableDamping === true ) {
                ...
                scope.publicSphericalDelta.theta = sphericalDelta.theta; // for orientation controls
    ...
    function dollyIn( dollyScale ) {
        ...
        if ( scope.object instanceof THREE.PerspectiveCamera ) {
            ...
            scope.AzimuthAngleLimits();
            scope.object.fov /= dollyScale;
    ...
    function handleMouseMoveRotate( event ) {
        ...
        scope.rotateUp( 2 * -Math.PI * rotateDelta.y / element.clientWidth * scope.rotateSpeed );
    ...
    function handleMouseMoveDolly( event ) {
        ...
        if ( dollyDelta.y > 0 ) {
            ...
            dollyIn( getZoomScale() + zoomScaleModifier );

        } else if ( dollyDelta.y < 0 ) {

            dollyOut( getZoomScale() + zoomScaleModifier );
    ...
    function handleTouchMoveDolly( event ) {
        ...
        // console.log( 'handleTouchMoveDolly, total ',(getZoomScale() + zoomScaleModifier) );
    ...
    scope.domElement.addEventListener( 'touchstart', onTouchStart, {passive: false}, false );
    scope.domElement.addEventListener( 'touchend', onTouchEnd, false );
    scope.domElement.addEventListener( 'touchmove', onTouchMove, {passive: false}, false );
